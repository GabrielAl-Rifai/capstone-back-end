...
// //Create
// router.post("http://localhost:3000/api/meals", async (req, res) => {
//   try {
...
// //Read
// router.get("http://localhost:3000/api/meals", async (req, res) => {
//   try {
...
// //Update
// router.put("http://localhost:3000/api/meals:id", async (req, res) => {
//   try {
